...
class M30BestVisualizer:
    def __init__(self):
        self.tp_pips = 70
        self.sl_pips = 80
        self.nanpin_interval = 15
    ...
    def load_data(self):
        ...
        df_m1 = load_m1_data()
        print("M30に変換中...")
        self.df = df_m1.resample('30min').agg({
    ...
    def visualize_full_performance(self, save_path):
        ...
        fig.suptitle(f'M30 Best Parameters: TP{self.tp_pips}/SL{self.sl_pips}/Nanpin{self.nanpin_interval}\n'
...
"""
    ...
    def visualize_monthly(self, save_path):
        ...
        fig.suptitle('Monthly Performance Analysis (M30)', fontsize=14, fontweight='bold')
...
def main():
    print("="*70)
    print("  M30ベストパラメータ 詳細可視化")
    print("  TP70/SL80/Nanpin15 (N3固定)")
    print("="*70)

    viz = M30BestVisualizer()
    viz.load_data()
    viz.run_backtest()

    print("\n可視化を生成中...")
    viz.visualize_full_performance('/Users/naoto/ドル円/m30_real_backtest/best_performance.png')
    viz.visualize_monthly('/Users/naoto/ドル円/m30_real_backtest/best_monthly.png')
